defmodule StateOfElixirWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StateOfElixirWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StateOfElixirWeb.Gettext, "errors", msg, opts)
    end
  end
